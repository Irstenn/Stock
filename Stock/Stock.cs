...
namespace Stock
{
    public partial class Stock : Form
    {
        ...
        //la fonction pour prendre le temps
        ...
        //Product Code et Quantity prennent que des nombres
        ...
        //Valide requete une fois que les informations entrer
            ...
            if (Validation())
            {
                ...
                else
                {
                    sqlQuery = @"INSERT INTO Stock (ProductCode, ProductName, TransDate, Quantity, ProductStatus)
                                 VALUES  ('" + textBox1.Text + "','" + textBox2.Text + "','" + dateTimePicker1.Value.ToString("dd/MM/yy") + "','" + textBox3.Text + "','" + status + "')";
                }
        ...
        private void dataGridView1_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            dateTimePicker1.Text = DateTime.Parse(dataGridView1.SelectedRows[0].Cells["dgDate"].Value.ToString()).ToString("dd/MM/yy");
