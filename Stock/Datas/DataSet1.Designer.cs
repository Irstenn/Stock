            ...
            public string ProductName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'ProductName\' в таблице \'Stock\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public System.DateTime TransDate {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'TransDate\' в таблице \'Stock\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public double Quantity {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Quantity\' в таблице \'Stock\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public bool ProductStatus {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'ProductStatus\' в таблице \'Products\' равно DBNull.", e);
                    }
                }
                set {
...
namespace Stock.Datas.DataSet1TableAdapters {
    ...
    public partial class StockTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Stock] WHERE (([ProductCode] = @Original_ProductCode) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_TransDate = 1 AND [TransDate] IS NULL) OR ([TransDate] = @Original_TransDate)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ([ProductStatus] = @Original_ProductStatus))";
...
SELECT ProductCode, ProductName, TransDate, Quantity, ProductStatus FROM Stock WHERE (ProductCode = @ProductCode)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Stock] SET [ProductCode] = @ProductCode, [ProductName] = @ProductName, [TransDate] = @TransDate, [Quantity] = @Quantity, [ProductStatus] = @ProductStatus WHERE (([ProductCode] = @Original_ProductCode) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_TransDate = 1 AND [TransDate] IS NULL) OR ([TransDate] = @Original_TransDate)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ([ProductStatus] = @Original_ProductStatus));
SELECT ProductCode, ProductName, TransDate, Quantity, ProductStatus FROM Stock WHERE (ProductCode = @ProductCode)";
        ...
        public virtual int Delete(int Original_ProductCode, string Original_ProductName, global::System.Nullable<global::System.DateTime> Original_TransDate, global::System.Nullable<double> Original_Quantity, bool Original_ProductStatus) {
            ...
            this.Adapter.DeleteCommand.Parameters[7].Value = ((bool)(Original_ProductStatus));
        ...
        public virtual int Insert(int ProductCode, string ProductName, global::System.Nullable<global::System.DateTime> TransDate, global::System.Nullable<double> Quantity, bool ProductStatus) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((bool)(ProductStatus));
        ...
        public virtual int Update(int ProductCode, string ProductName, global::System.Nullable<global::System.DateTime> TransDate, global::System.Nullable<double> Quantity, bool ProductStatus, int Original_ProductCode, string Original_ProductName, global::System.Nullable<global::System.DateTime> Original_TransDate, global::System.Nullable<double> Original_Quantity, bool Original_ProductStatus) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((bool)(ProductStatus));
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((bool)(Original_ProductStatus));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, global::System.Nullable<global::System.DateTime> TransDate, global::System.Nullable<double> Quantity, bool ProductStatus, int Original_ProductCode, string Original_ProductName, global::System.Nullable<global::System.DateTime> Original_TransDate, global::System.Nullable<double> Original_Quantity, bool Original_ProductStatus) {
