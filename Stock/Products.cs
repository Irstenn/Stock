    ...
    public partial class Products : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (validation())
            {
                ...
                // Reading Data ou lecture des donnees 
                LoadData();
               // button2.Text = "ADD"; ceci est un boutton de retour en cas de changement
                ResetRecords(); 
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                if (validation())
                {
                    ...
                    // Reading Data ou lecture des donnees telechargees 
                    LoadData();
                    ResetRecords();
                }
